...
def test_db_schema_creates_all_tables(tmp_path: Path):
    ...
    assert names == ["deployments", "dispatch_jobs", "features", "gate_verdicts", "non_runs",
...
def test_cli_parser_wires_all_subcommands():
    ...
    assert set(sub.choices) == {
        "project", "tool", "tools", "bundle", "roadmap", "task", "dispatch", "run", "abort", "interview",
        "deploy", "gate", "merge", "onboard", "bootstrap", "serve", "setup", "install-service", "doctor", "mcp",
    }
