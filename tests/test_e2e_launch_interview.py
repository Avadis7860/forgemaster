...
Sur un projet neuf **browser-game** (seed réel, pas un board contrôlé), la boucle complète tient bout-à-bout :
...
def test_launch_loop_closes_via_first_session_interview(ctx):
    ...
    # 0 — projet neuf browser-game : socle-design nu, task `interview` marquée interactive par le seed.
