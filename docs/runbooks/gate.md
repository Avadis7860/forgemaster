...
`src/cockpit/gate/toolchain.py:148` · appelé par `toolchain.cli_dispatch` (`cockpit gate toolchain <feature>`)
...
`src/cockpit/gate/toolchain.py:79`
...
`src/cockpit/gate/toolchain.py:106` · appelé par `run_toolchain`, `status`, `cli_dispatch`
...
`src/cockpit/gate/review.py:105` · appelé par `review.build_verdict`
...
`src/cockpit/gate/review.py:100`
...
`src/cockpit/gate/review.py:120` · appelé par `review.write_verdict`
...
`src/cockpit/gate/review.py:175` · appelé par `review.status`
...
`src/cockpit/gate/verify.py:39` · appelé par `gate/merge.evaluate_gate`
...
`src/cockpit/gate/verify.py:70` · appelé par `verify.cli_dispatch` (`cockpit gate verify <feature>`)
...
`src/cockpit/gate/merge.py:43` · appelé par `evaluate_gate`
...
`src/cockpit/gate/merge.py:157` · appelé par `run_merge` et par le GET gate (preview)
...
`src/cockpit/gate/merge.py:196` · appelé par `merge.cli_dispatch` (`cockpit merge <feature>`)
...
`src/cockpit/gate/merge.py:144` · appelé par `run_merge` (post-merge)
