...
`src/forgemaster/projects/deployments.py:25` · appelé par `create_project` (à la création) et `list_deployments` (à la lecture)
...
`src/forgemaster/projects/deployments.py:40` · appelé par le router deployments / P5 observabilité
...
`src/forgemaster/projects/deployments.py:50` · appelé par `set_deployment` (relecture) et les consommateurs P2/P5
...
`src/forgemaster/projects/deployments.py:59` · appelé par P2 (deploy) et P5 (observabilité)
