# README — projet semé par le forgemaster

Ce dépôt a été **provisionné par le forgemaster** : il naît avec un toolkit qui le rend **travaillable seul**
(un clone suffit) — le forgemaster ne fait qu'**automatiser** la même boucle, aux mêmes invariants.
