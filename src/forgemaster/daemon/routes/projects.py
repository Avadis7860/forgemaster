...
from forgemaster.daemon.routes.templates import known_template_slugs, template_source_dir
...
class ProjectCreate(BaseModel):
    ...
    #                                  l'adoption privée (avec credential) passe par `forgemaster bootstrap`
    # (P2).
