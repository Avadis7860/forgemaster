...
projet (routes API + verbes CLI), rendu par l'onglet Flow du forgemaster.
...
(`forgemaster.codemap.flow`). Projet absent → 404 (KeyError global) ; index/flot indisponible → 422.
"""
...
from forgemaster.codemap.index import CodemapError
