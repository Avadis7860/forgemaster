"""secrets.base — le contrat du coffre de credentials du forgemaster.
...
est choisi **globalement par instance** (`FORGEMASTER_SECRET_STORE`) — changer de backend = re-onboard.
