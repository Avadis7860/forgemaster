...
from forgemaster.codemap.index import CodemapError, ensure_index
...
def cli_dispatch(settings: Settings, args: argparse.Namespace) -> int:
    """Route `forgemaster tool sync <slug>` : re-synchronise un outil adopté (pull-only ff). Affiche l'action
    par
