...
- **interview de socle** (v14) : une session `forgemaster interview` est un `claude` INTERACTIF → **pas
d'event
...
def cli_dispatch(settings: Settings, args: argparse.Namespace) -> int:
    """Route `forgemaster cost <projet> [--by-step] [--json]` : total projet + rangées feature (et step si
