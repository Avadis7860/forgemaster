...
explicite (bouton UI / `forgemaster refix`), **dispatche UNE passe** de worker qui corrige les bloqueurs cités
sur
...
from forgemaster.dispatch import jobs, orchestrator, reviewer, worker
from forgemaster.gate import merge, review, toolchain
...
def cli_dispatch(settings: Settings, args: argparse.Namespace) -> int:
    """Route `forgemaster refix <project> <feature>` : UNE passe de correction bornée sur un gate rouge,
    imprime
