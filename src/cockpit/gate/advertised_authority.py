...
http://127.0.0.1:8000/x/`) alors que le cockpit publie sur un port dynamique (5250+).
...
Ce module ne connaît AUCUN type de projet : il vit dans `gate/` et se branche là où le cockpit sonde déjà
