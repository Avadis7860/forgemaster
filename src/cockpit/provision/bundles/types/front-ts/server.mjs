// server.mjs — page d'amorçage semée par le cockpit (P3). Sert un 200 out-of-the-box via le module http
...
// (le cockpit publie ${COCKPIT_PORT} → 8000).
import { createServer } from "node:http";

const PORT = 8000;
const PAGE = `<!doctype html><html lang="fr"><head><meta charset="utf-8">
<title>cockpit — amorçage</title></head>
<body><main><h1>front — amorçage</h1>
<p>Projet semé par le cockpit. Remplace ce stub par ton front.</p></main></body></html>`;
