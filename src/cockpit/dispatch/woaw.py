...
from cockpit.gate import verify, woaw
...
def build_woaw_prompt(screenshot_path: str, feature: dict, route: str) -> str:
    """Compose le prompt du juge woaw : rubrique P1–P7 EMBARQUÉE (la doctrine cockpit n'est pas dans le
...
def cli_dispatch(settings: Settings, args: argparse.Namespace) -> int:
    """Route `cockpit gate woaw-dispatch <feature>` : dispatche le juge woaw (si prêt + UI) → verdict
