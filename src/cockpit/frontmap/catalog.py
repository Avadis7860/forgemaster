...
frais par `ensure_index` (cache SHA+version). Jumeau de `cockpit.codemap.flow`, sans `--format json` (la
...
from cockpit.frontmap.index import FrontmapError, Runner, ensure_index, frontmap_argv
