...
rendue par l'onglet Docs du cockpit. La doc vit dans le repo (`docs/tool-card.md`), pas dans le cockpit
→ **SoT-and-derive** : mettre à jour la carte = éditer le repo, le cockpit la relit.
