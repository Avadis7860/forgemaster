...
routes), rendu par le panneau Frontmap du cockpit (onglet Ops), en parité avec ce que le worker interroge
...
(`cockpit.frontmap.catalog`). Projet absent → 404 (KeyError global) ; index/build indisponible → 422.
"""
...
from cockpit.frontmap.index import FrontmapError
